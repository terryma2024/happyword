...
- Runner toolchain: OpenCloudOS 9.4 with system `git`, `jq`, and `python3.12`.
  ...
  package for this OS image. Checkout uses the GitHub tarball API rather than
  `git fetch`, because Beijing-to-GitHub git pack transfer was observed to hang
  on this runner while archive download completed.
