...
- [ ] If missing, stop and ask the human owner. Do not edit iOS source.
...
- Preserve all stable IDs from `00-design.md` §5 as SwiftUI `accessibilityIdentifier` strings.
- Add XCTest / XCUITest counterparts for trigger §2.5.
