...
- [ ] Inspect current Android audio, battle, config, DevMenu, and UI test structure.
- [ ] Add/extend an Android PCM battle audio mixer equivalent:
...
- [ ] Add/extend Android config persistence for `autoSpeak`, `playBgm`, `actionSfx`, and switch-based question type selection.
- [ ] Update Compose config page:
...
- [ ] Add JVM/Compose UI parity coverage listed in trigger §2.5.
- [ ] Run commands from `.cursor/android-dev-commands.md`.
- [ ] Update `50-parity-checklist.md` Android column for rows that are implemented and green.
