...
final class BuiltinPackLoaderTests: XCTestCase {
    func testHarmonyRawfilesParseInCanonicalOrderAndPreserveMetadata() throws {
        ...
        XCTAssertEqual(fruit.scene.bossCandidates, [4, 5, 6])
        XCTAssertEqual(fruit.scene.monsterPlan.count, 5)
        XCTAssertEqual(fruit.scene.monsterPlan.first, MonsterPlanSlot(kind: .normal, catalogIndex: 0))
        XCTAssertEqual(fruit.scene.monsterPlan.last, MonsterPlanSlot(kind: .boss, catalogIndex: 5))
