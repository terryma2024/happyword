...
object BuiltinPacks {
    val all: List<WordPack> = listOf(
        pack(
            ...
            nameEn = "Fruit Forest",
            nameZh = "水果森林",
            storyEn = "Tiny lanterns glow as fruit friends guide each new word.",
            storyZh = "果林里的小灯亮起，水果朋友带孩子认识新的单词。",
            bgPrimary = "#FFF6E0",
            bgAccent = "#FFD49A",
        ...
        pack(
            ...
            nameZh = "校园城堡",
            storyEn = "The school castle rings its bell and opens a word quest.",
            storyZh = "校园城堡敲响铃声，打开一场单词小冒险。",
            bgPrimary = "#E8F0FE",
            bgAccent = "#AECBFA",
        ...
        pack(
            ...
            nameEn = "Home Cottage",
            nameZh = "家庭小屋",
            storyEn = "A cozy cottage hums softly while home words wake up.",
            storyZh = "温暖小屋轻轻哼唱，家里的单词一个个醒来。",
            bgPrimary = "#FFF1E6",
            bgAccent = "#F4B98A",
        ...
        pack(
            ...
            nameZh = "动物远征",
            storyEn = "Friendly animals leave paw prints toward today's word trail.",
            storyZh = "友好的动物留下脚印，带孩子走上今天的单词小路。",
            bgPrimary = "#FFF4D9",
            bgAccent = "#E0B973",
        ...
        pack(
            ...
            nameEn = "Ocean Realm",
            nameZh = "海洋王国",
            storyEn = "Blue waves sparkle as sea friends whisper new words.",
            storyZh = "蓝色海浪闪闪发光，海洋朋友悄悄送来新的单词。",
            bgPrimary = "#E0F4F7",
            bgAccent = "#7BB6BF",
